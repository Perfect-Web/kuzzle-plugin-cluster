...
class KuzzleCluster {
  ...
  constructor () {
    ...
    this.hooks = {
      'core:kuzzleStart': this.kuzzleStarted.bind(this),
      'core:indexCache:add': this.indexCacheAdded.bind(this),
      'core:indexCache:remove': this.indexCacheRemoved.bind(this),
      'core:notify:document': this.notifyDocument.bind(this),
      'core:notify:user': this.notifyUser.bind(this),
      'core:profileRepository:save': this.profileUpdated.bind(this),
      'core:profileRepository:delete': this.profileUpdated.bind(this),
      'core:roleRepository:save': this.roleUpdated.bind(this),
      'core:roleRepository:delete': this.roleUpdated.bind(this),
      'collection:afterUpdateSpecifications': this.refreshSpecifications.bind(this),
      'collection:afterDeleteSpecifications': this.refreshSpecifications.bind(this),
      'realtime:errorSubscribe': this.unlockCreateRoom.bind(this),
      'realtime:errorUnsubscribe': this.unlockDeleteRoom.bind(this),
      'room:new': this.roomCreated.bind(this),
      'room:remove': this.roomDeleted.bind(this),
      'admin:afterResetSecurity': this.resetSecurityCache.bind(this),
      'admin:afterDump': this.dump.bind(this),
      'admin:afterShutdown': this.shutdown.bind(this)
    };

    this.pipes = {
      'core:auth:strategyAdded': this.strategyAdded.bind(this),
      'core:auth:strategyRemoved': this.strategyRemoved.bind(this),
      'core:hotelClerk:addSubscription': this.subscriptionAdded.bind(this),
      'core:hotelClerk:removeRoomForCustomer': this.subscriptionOff.bind(this),
      'core:hotelClerk:join': this.subscriptionJoined.bind(this),
      'realtime:beforeJoin': this.beforeJoin.bind(this)
    };
